...
// definitions used for code written by Jamie Thorup
...
void LCD_PrintFloat(float num){
  ...
  #include <stdio.h>
  char convert[5];         // string from float number
  sprintf(convert, "%f", num);  // converts num to four digit string -> used to be %f
  LCD_PrintString(convert);
}
